...
//    std::unique_ptr<MessageBlockingConcurrentQueue<std::unique_ptr<proto::Transaction>>> MessageQueue::listen_message_txn_queue, MessageQueue::listen_message_epoch_queue;
