//
// Created by zwx on 23-8-7.
//

#ifndef TAAS_MPMC_QUEUE_H
#define TAAS_MPMC_QUEUE_H
...
public:
    explicit BlockingMPMCQueue(size_t size = 5000): queue(size) {}
...
#endif //TAAS_MPMC_QUEUE_H NEU_BLOCKCHAIN_BLOCKING_MPMC_QUEUE_H
